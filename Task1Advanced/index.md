...
### Создание подсетей для каталогов
...
### Публичный SSH-ключ (`ssh_public_key`)
...
### Сервисный аккаунт и аутентификация
...
### Различия конфигураций по окружениям
